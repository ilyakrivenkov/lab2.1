...
int main()
{
	...
	FILE *F = fopen ( "vafla.txt", "wt" );//открытие файла для записи (A,B)
	FILE *Ff = fopen ( "vafla1.txt", "wt" );//открытие файла для записи (Shellsort C)
	FILE *Fff = fopen ( "vafla11.txt", "wt" );//открытие файла для записи (QuickSort C) 
	FILE *Ffff = fopen ( "vafla111.txt", "wt" );//открытие файла для записи (Random(D))
	FILE *Fffff = fopen ( "vafla1111.txt", "wt" );//открытие файла для записи (A,B = C)
	FILE *Ffffff = fopen ( "vafla11111.txt", "wt" );//открытие файла для записи (QuickSort D)
	FILE *Fffffff = fopen ( "vafla111111.txt", "wt" );//открытие файла для записи (Shellsort D)
	FILE *Ffffffff = fopen ( "vafla1111111.txt", "wt" );//открытие файла для записи (G(ubiv))
	FILE *Fffffffff = fopen ( "vafla11111111.txt", "wt" );//открытие файла для записи (H(vozr))
	FILE *Ffffffffff = fopen ( "vafla111111111.txt", "wt" );//открытие файла для записи (QuickSort H)
	FILE *Fffffffffff = fopen ( "vafla1111111111.txt", "wt" );//открытие файла для записи (Shellsort H)
	FILE *Fa = fopen ( "vafla3.txt", "wt" );//открытие файла для записи (QuickSort G)
	FILE *Faa = fopen ( "vafla33.txt", "wt" );//открытие файла для записи (ShellSort G)
	FILE *Ft = fopen ( "vafla2.txt", "wt" );//открытие файла для записи (qsort C)
	FILE *Ftt = fopen ( "vafla22.txt", "wt" );//открытие файла для записи (qsort D)
	FILE *Fttt = fopen ( "vafla222.txt", "wt" );//открытие файла для записи (qsort G)
	FILE *Ftttt = fopen ( "vafla2222.txt", "wt" );//открытие файла для записи (qsort H)
	...
	fprintf(Fffffffff, "Первородный с возрастающими значениями массив:\n");//запись фразы в файл
	printf("Первородный массив с возрастающими значениями находится в файле vafla111111.txt:\n");
	fprintf(Ffffffff, "Первородный с убывающими значениями массив:\n");//запись фразы в файл
	printf("Первородный массив с убывающими значениями находится в файле vafla111111111.txt:\n");
	...
	fprintf(Fa, "Отсортированный с возр значениями быстрым способом массив:\n");//запись фразы в файл
	...
	//printf("Затраченно время в секундах на quick sort %f ", time_p);
    printf("\n");
	fprintf(Faa, "Отсортированный с возр значениями способом Шелла массив:\n");//запись фразы в файл
	...
	fprintf(Ffffffffff, "Отсортированный с убыв значениями быстрым способом массив:\n");//запись фразы в файл
    ...
    printf("\n");
	fprintf(Fffffffffff, "Отсортированный с убыв значениями способом Шелла массив:\n");//запись фразы в файл
	...
	printf("*----------------------------------------------------------*");
	printf("\n");
	printf("* Последовательность *  QuickSort  *  Shellsort  *  qsort  *");
	printf("\n");
	printf("* Рандом             *  %f",time_p);
	printf("   *%f", time_s);
	printf("     *%f", time_potani);
	printf(" *");

	printf("\n");
	printf("* Возр и убыв        *  %f",time_potr);
	printf("   *%f", time_spent);
	printf("     *%f", time_potan);
	printf(" *");

	printf("\n");
	printf("* Возр               *  %f",time_pot);
	printf("   *%f", time_st);
	printf("     *%f", time_potanic);
	printf(" *");

	printf("\n");
	printf("* Убыв               *  %f",time_pota);
	printf("   *%f", time_sta);
